...
it('Registration', () => {
    ...
    cy.get('#AccountFrm_email').type('fakeMail66@mail.com');
    ...
    cy.get('#AccountFrm_loginname').type('testUsernameForAutomation66');
    ...
    cy.get('h1 span.subtext').should('have.text', 'FirstTestName')
})
